...
import { BestTravel, combinations } from "../src/bestTravel";
...
describe("Fixed Tests", () => {
    ...
    describe("combinations Tests", () => {
        ...
        it("combinations 3 2", () => {
            deepStrictEqual(combinations(3, 2), [[0, 1], [0, 2], [1, 2]]);
        });
        it("combinations 4 2", () => {
    ...
    describe("chooseBestSum Tests", () => {
        ...
        it.skip("choosebestsum 1", () => {
            const ts = [50, 55, 56, 57, 58];
            dotest(163, 3, ts, 163);
        });

        it.skip("choosebestsum 2", () => {
            const ts = [50];
            dotest(163, 3, ts, null);
        });

        it.skip("choosebestsum 3", () => {
